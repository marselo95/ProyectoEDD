...
public class VPedido extends javax.swing.JFrame {
    ...
    public modificarInventario(String producto, int cantidad, Nodo producto, int opcion){
        if (opcion == 1){
            producto.setExistencias(producto.getExistencia() + cantidad);
        }
        else{
            producto.setExistencias(producto.getExistencia() - cantidad);
        }
    ...
    public Comparar(Lista productos, String producto) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Pedido, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 120, -1));
    ...
    private void PedidoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PedidoMouseClicked
        // TODO add your handling code here:
        String Producto = input.getText.toLowerCase();   
        int almacen = ialmacen.toUpperCase().getNumVertice();
        int cantidad = icantidad;
