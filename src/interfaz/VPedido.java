...
public class VPedido extends javax.swing.JFrame {
    ...
    private void PedidoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PedidoMouseClicked
        ...
        try {
            ...
            if (mat == null || (Global.getPendientes() == 0)) {
                ///////////// Aqui va solicitar a otro almacen
                
                Lista almacenesProducto = fr.almacenesDisponibles(Global.getMatriz().verts, Producto, Global.getMatriz().verts[almacen].getName());
                int cantidadRestante = Global.getPendientes();
                
                if (almacenesProducto.getSize() != 0) {
                    String a = almacenesProducto.getpFirst().getNombre();
                    ...
                    JOptionPane.showMessageDialog(null, "Producto no disponible o no existe, verifique el stock");
                }
